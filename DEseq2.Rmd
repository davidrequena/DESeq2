...
plotPCA_DR <- function (object, intgroup = "condition", ntop = 500, PCs = c(1,2), size = 7, alpha = 1,
...
ggsave("Plots/tSNE_features.jpg", p.tsne, width = 16, height = 10, dpi = 300)
ggsave("Plots/tSNE_big_clean.jpg", p.tsne_big_clean, width = 8.5, height = 7, dpi = 300)
ggsave("Plots/tSNE_big_features.jpg", p.tsne_big, width = 8.5, height = 7, dpi = 300)
```
...
plotBoxScatter_DR <- function (genename = NULL, symbol = NULL)
{
...
for (i in 1:nrow(interesting_genes)) {
  ggsave(paste0("By_Gene/Underexp/", interesting_genes[i, 2], ".jpg"),
         plotBoxScatter_DR(toString(interesting_genes[i, 1]), toString(interesting_genes[i, 2])),
